      ...
      <nav className="navbar navbar-expand-md navbar-dark navbar-custom fixed-top">
        ...
        <div className="collapse navbar-collapse" id="navbarsExampleDefault">
          <ul className="navbar-nav ml-auto">
            ...
            <li className="nav-item">
              <a className="nav-link page-scroll" href="#callMe">
                CALL ME
              </a>
            </li>
            <li className="nav-item">
          ...
          <div className="row">
            <div className="col-lg-5">
              <div className="text-container">
                ...
                <p>
                  Launching a new company or developing the market position of
                  an existing one can be quite an overwhelming processs at
                  times.
                </p>
                <p className="testimonial-text">
                  "Our mission here at Aira is to get you through those tough
                  moments relying on our team's expertise in starting and
                  growing companies."
                </p>
            ...
            <div className="col-lg-12">
              ...
              <div className="card">
                ...
                <div className="card-body">
                  ...
                  <p>
                    After completing the environmental analysis the next stage
                    is to design and plan your development strategy
                  </p>
                </div>
              </div>
              ...
              <div className="card">
                ...
                <div className="card-body">
                  ...
                  <p>
                    In this phase you will focus on executing the actions plan
                    and evaluating the results after each marketing campaign
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="area-2">
          <div className="accordion-container" id="accordionOne">
            ...
            <div className="item">
              ...
              >
                <div className="accordion-body">
                  At Aria solutions, we’ve taken the consultancy concept one
                  step further by offering a full service management
            ...
            <div className="item">
              ...
              >
                <div className="accordion-body">
                  An awesome online marketing plan won't save your bad product
                  but paired with a good product, the sky is the limit for what
                  can be achieved.
                </div>
              </div>
            </div>
        ...
        <div className="area-1">
          <div className="tabs-container">
            ...
            <div className="tab-content" id="ariaTabsContent">
              ...
              >
                <ul className="list-unstyled li-space-lg first">
                  <li className="media">
                    ...
                    <div className="media-body">
                      <strong>High quality</strong> is on top of our list when
                      it comes to the way we deliver the services
                    </div>
                  </li>
                  <li className="media">
                  ...
                  <li className="media">
                    ...
                    <div className="media-body">
                      <strong>Quality standards</strong> are important but meant
                      to be exceeded
                    </div>
                  </li>
                </ul>
                <ul className="list-unstyled li-space-lg last">
                  <li className="media">
                    ...
                    <div className="media-body">
                      <strong>We're always looking</strong> for industry leaders
                      to help them win their market position
                    </div>
                  </li>
                  <li className="media">
                    <div className="media-bullet">5</div>
                    <div className="media-body">
                      <strong>Evaluation</strong> is a key aspect of this
              ...
              >
                <p>
                  <strong>We strive to achieve</strong> 100% customer
                  satisfaction for both types of customers: hiring companies and
                  job seekers. Types of customers:{' '}
                ...
                <p>
                  ...
                  full potential and establish long term stability for{' '}
                  <a className="green" href="#your-link">
                    the stakeholders
                  </a>
                </p>
                  ...
                  <div className="swiper-wrapper">
                      ...
                      <div className="card">
                        ...
                        <div className="card-body">
                          <div className="testimonial-text">
                            ...
                            off the ground and turning into a profitable
                            company.
                          </div>
                    ...
                    <div className="swiper-slide">
                      <div className="card">
                        ...
                        <div className="card-body">
                          <div className="testimonial-text">
                            I purchased the Growth Accelerator service pack a
                            few years ago and I renewed the contract each year.{' '}
                          </div>
                          <div className="testimonial-author">
                    ...
                    <div className="swiper-slide">
                      <div className="card">
                        ...
                        <div className="card-body">
                          <div className="testimonial-text">
                            Aria's CEO personally attends client meetings and
                            gives his feedback on business growth strategies.
                          </div>
                          <div className="testimonial-author">
                            Roy Smith - Developer
                          </div>
                    ...
                    <div className="swiper-slide">
                      <div className="card">
                        ...
                        <div className="card-body">
                          <div className="testimonial-text">
                            At the beginning I thought the prices are a little
                            high for what they offer but they over deliver each
                            and every time.
                          </div>
                          <div className="testimonial-author">
                            Ronald Spice - Owner
                      ...
                      <div className="card">
                        ...
                        <div className="card-body">
                          <div className="testimonial-text">
                            ...
                            leader that wants to take his company to the next
                            level.
                          </div>
                          <div className="testimonial-author">
                      ...
                      <div className="card">
                        ...
                        <div className="card-body">
                          <div className="testimonial-text">
                            ...
                            I first set them but they've met them with no
                            problems.
                          </div>
                          <div className="testimonial-author">
            ...
            <div className="col-lg-6">
              <div className="text-container">
                ...
                <p className="white">
                  ...
                  fill in the form and send it to us and we'll get right back
          ...
          <div className="row">
            <div className="col-lg-12">
              ...
              <p className="p-heading">
                ...
                are the men and women which help customers meet goals and grow
                companies
              </p>
            </div>
          </div>
          ...
          <div className="row">
            ...
            <div className="col-lg-7 col-xl-6">
              <div className="text-container">
                ...
                <p>
                  Our goal is to provide the right business growth services at
                  the appropriate time so companies can benefit from the created
          ...
          <div className="row">
            <div className="col-lg-6">
              <div className="text-container">
                ...
                <p>
                  You can stop by our office for a cup of coffee and just use
                  the contact form below for any questions and inquiries
                </p>
                <ul className="list-unstyled li-space-lg">
            ...
            <div className="col-md-6">
              <div className="text-container about">
                ...
                <p className="white">
                  ...
                  services for companies just starting out as startups or
                  industry players that have established their market position a
                  long tima ago.
                </p>
              </div>
            </div>
